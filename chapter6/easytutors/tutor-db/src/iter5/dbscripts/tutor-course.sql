...
drop user if exists trueuser;
create user trueuser with password 'trupwd';
...
grant all privileges on table ezy_tutor_c6 to trueuser;
grant all privileges on table ezy_course_c6 to trueuser;
grant all privileges on all sequences in schema public to trueuser;
